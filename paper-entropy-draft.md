...
**Data Availability Statement:** All experiment code and data are publicly available at https://github.com/Windstorm-Labs/inherited-constraint (accessed 12 April 2026).

**Acknowledgments:** All experiments were performed with the assistance of Claude (Anthropic), an AI research tool. Energy measurements were conducted on an NVIDIA RTX 5090.
...
9. Miller, G.A.; Nicely, P.E. An Analysis of Perceptual Confusions among Some English Consonants. *J. Acoust. Soc. Am.* **1955**, *27*, 338--352. DOI: 10.1121/1.1907526
10. Whitmer, G.L., III. Inherited Constraint: Experiment Code and Data. *GitHub* **2026**. Available online: https://github.com/Windstorm-Labs/inherited-constraint (accessed 12 April 2026).
