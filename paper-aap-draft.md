...
The companion paper on the dissipative decoder proved that silicon AI has no thermodynamic throughput basin: its energy scales sub-linearly with model capacity. Yet AI models converge on approximately 3.90 bits of effective information per token — within the biological throughput basin. This study tests the hypothesis that AI inherits its throughput from the biological systems that generated its training data. Background: human language evolved inside brains constrained by the throughput basin (approximately 4-5 bits per cognitive event), and AI models are trained on human text. Purpose: to measure the information density of human language using a basin-blind experimental design and determine whether syntactic structure is the mechanism by which biological constraints are transmitted to AI. Methods: bits-per-token (BPT) was measured across seven corpora (natural language, programming code, DNA sequences, synthetic structured data, mathematical notation, random text, and shuffled English) using four models (Pythia-70m, Pythia-410m, GPT-2, GPT-2-large) on standardized hardware (RTX 5090). A granular shuffling cascade destroyed structure at successive levels (paragraphs, sentences, within-sentence word order, all words). The Zipf exponent was computed for original and shuffled text. Energy consumption was measured at 10ms intervals. Results: natural language produces BPT of approximately 3.90 bits (mean across four models), near the low edge of the biological basin (centroid 4.16 +/- 0.19 bits) and within about 0.5 bits of the ribosome (4.39 bits per codon). Destroying word order more than doubles per-token surprise to approximately 10.8 bits. The granular cascade localizes the dominant structure to sentence-internal word order (syntax), which contributes approximately 3.3 bits — more than discourse (1.3 bits), sentence ordering (0.6 bits), and all other levels combined. The Zipf exponent is identical in original and shuffled English (alpha = -0.843, R^2 = 0.992), proving that word-frequency statistics are necessary but not sufficient for the approximately 3.90-bit convergence. Natural language costs 20% more energy per token than shuffled text (0.347 versus 0.291 millijoules), demonstrating that structure exploitation has a measurable thermodynamic price. A four-link causal chain is proposed: physics constrains biology (established), biology constrains cognition (established), cognition constrains language (supported), and language constrains AI (supported). Two critical links remain hypothesized rather than causally demonstrated, and four falsifiable predictions are offered. This is the sixth paper in a nine-paper series.

**Keywords:** inherited constraint, information density, bits per token, language structure, Zipf's law, shuffling cascade, syntax, throughput basin, biological constraint, uniform information density
...
Human language produces approximately 3.90 bits of per-token surprise in a basin-blind measurement — near the low edge of the throughput basin (centroid 4.16 +/- 0.19 bits), within about 0.5 bits of the ribosome (4.39 bits) and comparable to Shannon's 1951 estimate (approximately 5 bits per word). Destroying syntax doubles per-token surprise to approximately 10.8 bits; syntax keeps language in the basin. The granular shuffling cascade identifies sentence-internal word order as the dominant structural carrier (approximately 3.3 bits). The Zipf distribution is identical in original and shuffled text yet information extraction differs by approximately 6 bits, proving that word statistics are necessary but insufficient. A four-link causal chain — physics to biology to cognition to language to AI — is proposed, with Links 1-2 empirically established and Links 3-4 supported by convergent evidence but not yet causally demonstrated. Two falsifiable predictions would confirm or refute the inherited constraint hypothesis. Until tested, it remains a hypothesis consistent with available data and a research program for future investigation.
...
Grant Lavell Whitmer III conceived the inherited constraint hypothesis, designed the seven-corpus experimental protocol, directed all computational experiments, analyzed all results, and prepared the manuscript.
...
[1] Whitmer III, G.L. "The Fons Constraint: Information-Theoretic Convergence on Encoding Depth in Self-Replicating Systems," Zenodo, 2026. DOI: 10.5281/zenodo.19274047
...
[3] Whitmer III, G.L. "The Throughput Basin: Cross-Substrate Convergence and Decomposition of Serial Decoding Throughput," Zenodo, 2026. DOI: 10.5281/zenodo.19323193

[4] Whitmer III, G.L. "The Serial Decoding Basin: Five Experiments on Convergence, Thermodynamic Anchoring, and Receiver-Limited Geometry," Zenodo, 2026. DOI: 10.5281/zenodo.19323422

[5] Whitmer III, G.L. "The Dissipative Decoder: Thermodynamic Cost Bounds on the Serial Decoding Throughput Basin," Zenodo, 2026. DOI: 10.5281/zenodo.19432785

[6] Shannon, C.E. "Prediction and Entropy of Printed English," Bell System Technical Journal, vol. 30, no. 1, pp. 50-64, 1951. DOI: 10.1002/j.1538-7305.1951.tb01366.x

[7] Jaeger, T.F. "Redundancy and reduction: Speakers manage syntactic information density," Cognitive Psychology, vol. 61, no. 1, pp. 23-62, 2010. DOI: 10.1016/j.cogpsych.2010.02.002

[8] Miller, G.A. "The magical number seven, plus or minus two: Some limits on our capacity for processing information," Psychological Review, vol. 63, no. 2, pp. 81-97, 1956. DOI: 10.1037/h0043158

[9] Miller, G.A.; Nicely, P.E. "An analysis of perceptual confusions among some English consonants," Journal of the Acoustical Society of America, vol. 27, no. 2, pp. 338-352, 1955. DOI: 10.1121/1.1907526

[10] Whitmer III, G.L. "Inherited Constraint: Experiment Code and Data," GitHub, 2026. https://github.com/Windstorm-Labs/inherited-constraint (accessed Apr. 12, 2026).

---

*This paper is Paper 6 of The Windstorm Series. The series includes Paper 1: The Fons Constraint [1], Paper 2: The Receiver-Limited Floor [2], Paper 3: The Throughput Basin [3], Paper 4: The Serial Decoding Basin [4], Paper 5: The Dissipative Decoder [5], and Paper 7: The Throughput Basin Origin (DOI: 10.5281/zenodo.19498582).*
