# Paper 6: The Inherited Constraint
...
**Zenodo**: [10.5281/zenodo.19432911](https://doi.org/10.5281/zenodo.19432911) · **Current version: v1.0** (April 2026)
...
- **[Zenodo record](https://doi.org/10.5281/zenodo.19432911)** — archived with DOI
...
**[Windstorm-Labs/inherited-constraint](https://github.com/Windstorm-Labs/inherited-constraint)**

---

## Discuss this paper

- **Discuss the paper's ideas** → [Comments on the website article](https://windstorminstitute.org/articles/inherited-constraint.html#comments) (powered by GitHub Discussions on the website repo)
- **Typo, citation issue, or paper-content correction?** → [Open an Issue on this repo](../../issues)
- **Bug in the analysis code, or a reproduction question?** → [Issue](https://github.com/Windstorm-Labs/inherited-constraint/issues) or [Discussion](https://github.com/Windstorm-Labs/inherited-constraint/discussions) on the Labs repo
